...
def msg_all_clients(msg):
    ...
    while clientID < len(clients):
        try:
            ...
            print("===================================")
            print("Could not send data to client {0}. It is likely they are no longer present on the network.".format(clientID))
            ...
            print("===================================")
###############################################################################
#saves message history to server.log every x seconds
def savelog(log):
    x = 10
